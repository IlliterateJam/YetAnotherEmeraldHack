...
extern const u8 gText_FocusBand48BP[];
extern const u8 gText_LightClayDesc48BP[];
extern const u8 gText_RockyHelmetDesc48BP[];
extern const u8 gText_AssaultVestDesc48BP[];
extern const u8 gText_SafetyGogglesDesc48BP[];
extern const u8 gText_ClearAmuletDesc56BP[];
extern const u8 gText_PunchingGloveDesc56BP[];
extern const u8 gText_CovertCloakDesc56BP[];
extern const u8 gText_EvioliteDesc64BP[];
...
extern const u8 gText_SnoruntAndPrice[];
...
extern const u8 gText_RYBShard[];
extern const u8 gText_RYGShard[];
extern const u8 gText_RBGShard[];
extern const u8 gText_YBGShard[];
...
extern const u8 gText_AmberFossil[];
