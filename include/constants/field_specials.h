...
#define SCROLL_MULTI_BF_EXCHANGE_CORNER_CONS_ITEM_VENDOR   7
#define SCROLL_MULTI_BF_EXCHANGE_CORNER_EVO_ITEM_VENDOR     8
#define SCROLL_MULTI_BF_EXCHANGE_CORNER_BERRY_ITEM_VENDOR   9
