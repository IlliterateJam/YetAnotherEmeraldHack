...
static const u16 sItemsByType[ITEMS_COUNT] =
{
    ...
    [ITEM_RETRO_MAIL] = ITEM_TYPE_MAIL,
        ...
        [ITEM_HEALTH_MOCHI] = ITEM_TYPE_STAT_BOOST_DRINK,
        [ITEM_MUSCLE_MOCHI] = ITEM_TYPE_STAT_BOOST_DRINK,
        [ITEM_RESIST_MOCHI] = ITEM_TYPE_STAT_BOOST_DRINK,
        [ITEM_GENIUS_MOCHI] = ITEM_TYPE_STAT_BOOST_DRINK,
        [ITEM_CLEVER_MOCHI] = ITEM_TYPE_STAT_BOOST_DRINK,
        [ITEM_SWIFT_MOCHI]  = ITEM_TYPE_STAT_BOOST_DRINK,
        [ITEM_MIRROR_HERB]     = ITEM_TYPE_MOCHI,
        [ITEM_ABILITY_SHIELD]  = ITEM_TYPE_MOCHI,
        [ITEM_CLEAR_AMULET]    = ITEM_TYPE_MOCHI,
        [ITEM_PUNCHING_GLOVE]  = ITEM_TYPE_MOCHI,
        [ITEM_COVERT_CLOAK]    = ITEM_TYPE_MOCHI,
        [ITEM_LOADED_DICE]     = ITEM_TYPE_MOCHI,
        ...
        [ITEM_EXP_CANDY_XS]   = ITEM_TYPE_CANDY,
        [ITEM_EXP_CANDY_S]    = ITEM_TYPE_CANDY,
        [ITEM_EXP_CANDY_M]    = ITEM_TYPE_CANDY,
        [ITEM_EXP_CANDY_L]    = ITEM_TYPE_CANDY,
        [ITEM_EXP_CANDY_XL]   = ITEM_TYPE_CANDY,
        [ITEM_EXP_SWEET_XS]   = ITEM_TYPE_CANDY,
        [ITEM_EXP_SWEET_S]    = ITEM_TYPE_CANDY,
        [ITEM_EXP_SWEET_M]    = ITEM_TYPE_CANDY,
        [ITEM_EXP_SWEET_L]    = ITEM_TYPE_CANDY,
        [ITEM_EXP_SWEET_XL]   = ITEM_TYPE_CANDY,
        [ITEM_DYNAMAX_CANDY]  = ITEM_TYPE_CANDY,
};
