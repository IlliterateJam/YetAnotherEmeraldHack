...
static const u16 sVerdanturfTentRewards[] = {ITEM_SPORT_BALL};
...
static const u16 sFallarborTentRewards[] = {ITEM_SCOPE_LENS};
...
static const u16 sSlateportTentRewards[] = {ITEM_TM_AIR_CUTTER};
