...
static const u8 *const sScrollableMultichoiceOptions[][MAX_SCROLL_MULTI_LENGTH] =
{
    ...
    {
        gText_MuscleMochi1BP,
        gText_ResistMochi1BP,
        gText_GeniusMochi1BP,
        gText_CleverMochi1BP,
        gText_SwiftMochi1BP,
        gText_HealthMochi1BP,
        gText_Protein1BP,
        gText_Calcium1BP,
        gText_Iron1BP,
        gText_Zinc1BP,
    ...
    [SCROLL_MULTI_BF_EXCHANGE_CORNER_CONS_ITEM_VENDOR] =
    {
        gText_EjectButton48BP,
        gText_EjectPack48BP,
        gText_RedCard48BP,
        gText_AirBalloon48BP,
        gText_ThroatSpray48BP,
        gText_FocusSash56BP,
        gText_WeaknessPolicy56BP,
