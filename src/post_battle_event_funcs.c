...
int GameClear(void)
{
    ...
    FlagClear(FLAG_MOVE_TUTOR_TAUGHT_ROLLOUT);
    FlagClear(FLAG_MOVE_TUTOR_TAUGHT_FURY_CUTTER);
    FlagClear(FLAG_MOVE_TUTOR_TAUGHT_MIMIC);
    FlagClear(FLAG_MOVE_TUTOR_TAUGHT_METRONOME);
    FlagClear(FLAG_MOVE_TUTOR_TAUGHT_SLEEP_TALK);
    FlagClear(FLAG_MOVE_TUTOR_TAUGHT_SUBSTITUTE);
    FlagClear(FLAG_MOVE_TUTOR_TAUGHT_DYNAMICPUNCH);
    FlagClear(FLAG_MOVE_TUTOR_TAUGHT_DOUBLE_EDGE);
    FlagClear(FLAG_MOVE_TUTOR_TAUGHT_EXPLOSION);
    FlagClear(FLAG_MOVE_TUTOR_TAUGHT_EXTREME_SPEED);
