...
const u16 gBattleFrontierHeldItems[] =
{
    ...
    [BATTLE_FRONTIER_ITEM_THROAT_SPRAY]      = ITEM_THROAT_SPRAY,
    [BATTLE_FRONTIER_ITEM_EJECT_PACK]        = ITEM_EJECT_PACK,
    ...
    [BATTLE_FRONTIER_ITEM_RINDO_BERRY]    = ITEM_RINDO_BERRY,
    [BATTLE_FRONTIER_ITEM_YACHE_BERRY]    = ITEM_YACHE_BERRY,
    [BATTLE_FRONTIER_ITEM_CHOPLE_BERRY]   = ITEM_CHOPLE_BERRY,
    [BATTLE_FRONTIER_ITEM_KEBIA_BERRY]    = ITEM_KEBIA_BERRY,
    [BATTLE_FRONTIER_ITEM_SHUCA_BERRY]    = ITEM_SHUCA_BERRY,
    [BATTLE_FRONTIER_ITEM_COBA_BERRY]     = ITEM_COBA_BERRY,
    [BATTLE_FRONTIER_ITEM_PAYAPA_BERRY]   = ITEM_PAYAPA_BERRY,
    [BATTLE_FRONTIER_ITEM_TANGA_BERRY]    = ITEM_TANGA_BERRY,
    [BATTLE_FRONTIER_ITEM_CHARTI_BERRY]   = ITEM_CHARTI_BERRY,
    [BATTLE_FRONTIER_ITEM_KASIB_BERRY]    = ITEM_KASIB_BERRY,
    [BATTLE_FRONTIER_ITEM_HABAN_BERRY]    = ITEM_HABAN_BERRY,
