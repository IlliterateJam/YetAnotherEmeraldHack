...
static const u8 sMagmaArmorDescription[] = _("Boosts Fire Power.");
static const u8 sWaterVeilDescription[] = _("Guards from fire and burns.");
...
static const u8 sWaterBubbleDescription[] = _("Boosts Power of Water");
...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_ICE_SCALES] = _("Tough Scales"),
    ...
    [ABILITY_GOOD_AS_GOLD] = _("Good Herb"),
